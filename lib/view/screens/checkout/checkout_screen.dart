...
class CheckoutScreenState extends State<CheckoutScreen> {
  ...
  void initState() {
    ...
    if (_isLoggedIn) {
      _streetNumberController.text =
          Get.find<LocationController>().getUserAddress()!.streetNumber ?? '';
      _houseController.text =
          Get.find<LocationController>().getUserAddress()!.house ?? '';
      ...
      body: _isLoggedIn
          ? GetBuilder<LocationController>(builder: (locationController) {
              return GetBuilder<StoreController>(builder: (storeController) {
                ...
                addressList.add(DropdownMenuItem<int>(
                    value: -1,
                    child: SizedBox(
                  ...
                  return GetBuilder<OrderController>(
                    ...
                    if (storeController.store != null && _cartList != null) {
                      for (var cartModel in _cartList!) {
                        ...
                        double? dis = (storeController.store!.discount !=
                                    null &&
                        ...
                        String? disType = (storeController.store!.discount !=
                                    null &&
                                DateConverter.isAvailable(
                                    storeController.store!.discount!.startTime,
                                    storeController.store!.discount!.endTime))
                                                                  ...
                                                                  ? ListView
                                                                      ...
                                                                      itemBuilder:
                                                                          (context,
                                                                              index) {
                                                                        return SlotWidget(
                                                                          title: (index == 0 && orderController.selectedDateSlot == 0 && storeController.isStoreOpenNow(storeController.store!.active!, storeController.store!.schedules) && (module!.orderPlaceToScheduleInterval! ? storeController.store!.orderPlaceToScheduleInterval == 0 : true))
                                                                              ? 'now'.tr
                                                                ...
                                                                decoration:
                                                                  ...
                                                                  border:
                                                                    ...
                                                                    borderRadius:
                                                                        BorderRadius
                                                                            .horizontal(
                                                                      left: Radius.circular(Get.find<LocalizationController>()
                                                                              .isLtr
                                                                          ? 10
                                                                          : 0),
                                                                      right: Radius.circular(Get.find<LocalizationController>()
                                                                              .isLtr
                                                                          ? 0
                                                                          : 10),
                                                                    ),
  ...
  void _callback(bool isSuccess, String? message, String orderID, int? zoneID,
      double amount, double? maximumCodOrderAmount) async {
    if (isSuccess) {
      if (widget.fromCart) {
              ...
              onPressed: orderController.acceptTerms
                  ? () {
                      ...
                      if (!_isCashOnDeliveryActive! &&
                        ...
                        AddressModel? address = orderController.addressIndex ==
                                -1
                            ? Get.find<LocationController>().getUserAddress()
                            : locationController
